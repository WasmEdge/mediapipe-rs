...
const MODEL_1: &str = "assets/models/object_detection/efficientdet_lite0_fp32.tflite";
const MODEL_2: &str = "assets/models/object_detection/efficientdet_lite0_uint8.tflite";
const MODEL_3: &str = "assets/models/object_detection/efficientdet_lite2_fp32.tflite";
const MODEL_4: &str = "assets/models/object_detection/efficientdet_lite2_uint8.tflite";
const MODEL_5: &str = "assets/models/object_detection/mobilenetv2_ssd_256_fp32.tflite";
const MODEL_6: &str = "assets/models/object_detection/mobilenetv2_ssd_256_uint8.tflite";
const IMG: &str = "assets/testdata/img/cat_and_dog.jpg";
